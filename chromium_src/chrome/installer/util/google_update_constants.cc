...
const wchar_t kRegPathClients[] = L"Software\\DarkTrekSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\DarkTrekSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\DarkTrekSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\DarkTrekSoftware\\Update";
